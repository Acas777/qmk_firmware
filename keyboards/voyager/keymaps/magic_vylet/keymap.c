...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_voyager(
    ...
    OSM(MOD_LCTL),  RGB_VAD,        RGB_VAI,        KC_MS_BTN2,     KC_MS_BTN1,     KC_PSCR,                                        KC_F11,         KC_F12,         KC_DOT,         KC_QUOTE,       KC_SCLN,        KC_ENTER,       
...
const uint16_t PROGMEM comboOSMalt[] = { KC_B, KC_F, COMBO_END};
const uint16_t PROGMEM comboOSMaltNAV[] = { KC_PAGE_UP, KC_PGDN, COMBO_END};
...
const uint16_t PROGMEM comboGui[] = { KC_K, KC_SPACE, COMBO_END};
const uint16_t PROGMEM comboGuiNAV[] = { KC_PSCR, KC_SPACE, COMBO_END};
...
combo_t key_combos[COMBO_COUNT] = {
    ...
    COMBO(comboOSMaltNAV, OSM(MOD_LALT)),
    ...
    COMBO(comboGui, KC_LEFT_GUI),
    COMBO(comboGuiNAV, KC_LEFT_GUI),
    COMBO(comboNav, TO(2)),
};
